    ...
    public partial class WeaponPlus : TerrariaPlugin
    {
        ...
        public bool Deduction(WItem WItem, TSPlayer whoAMI, PlusType plusType, int gap)
        {
            ...
            if (DeductCoin(whoAMI, price))
            {
                ...
                whoAMI.SendMessage(LangTipsGet("扣除钱币：") + cointostring(price, out List<Item> items) + "   " + LangTipsGet("当前剩余：") + cointostring(num1 + num2 + num3 + num4 + num5, out items), Color.Pink);
                return true;
            }
        ...
        public bool DeductCoin(TSPlayer one, long coin)
        {
            ...
            for (int i = 0; i < NetItem.MaxInventory; i++)
            {
                ...
                {
                    int num7 = i - NetItem.PiggyIndex.Item1;
                ...
                {
                    int num8 = i - NetItem.SafeIndex.Item1;
                ...
                {
                    int num9 = i - NetItem.ForgeIndex.Item1;
                ...
                else
                {
                    ...
                    int num10 = i - NetItem.VoidIndex.Item1;
            ...
            if (num2 > 0)
            {
                for (int j = NetItem.MiscDyeIndex.Item2; j < NetItem.PiggyIndex.Item2; j++)
                {
                    int num11 = j - NetItem.PiggyIndex.Item1;
                ...
                for (int k = NetItem.MiscDyeIndex.Item2; k < NetItem.PiggyIndex.Item2; k++)
                {
                    int num12 = k - NetItem.PiggyIndex.Item1;
            ...
            {
                for (int l = NetItem.PiggyIndex.Item2; l < NetItem.SafeIndex.Item2; l++)
                {
                    int num13 = l - NetItem.SafeIndex.Item1;
                ...
                cointostring(num6, out items);
                for (int m = NetItem.PiggyIndex.Item2; m < NetItem.SafeIndex.Item2; m++)
                {
                    int num14 = m - NetItem.SafeIndex.Item1;
            ...
            {
                for (int n = NetItem.TrashIndex.Item2; n < NetItem.ForgeIndex.Item2; n++)
                {
                    int num15 = n - NetItem.ForgeIndex.Item1;
                ...
                cointostring(num6, out items);
                for (int num16 = NetItem.TrashIndex.Item2; num16 < NetItem.ForgeIndex.Item2; num16++)
                {
                    int num17 = num16 - NetItem.ForgeIndex.Item1;
            ...
            {
                for (int num18 = NetItem.ForgeIndex.Item2; num18 < NetItem.VoidIndex.Item2; num18++)
                {
                    int num19 = num18 - NetItem.VoidIndex.Item1;
                ...
                cointostring(num6, out items);
                for (int num20 = NetItem.ForgeIndex.Item2; num20 < NetItem.VoidIndex.Item2; num20++)
                {
                    int num21 = num20 - NetItem.VoidIndex.Item1;
            ...
            {
                for (int num22 = 0; num22 < NetItem.InventoryIndex.Item2; num22++)
                {
                ...
                cointostring(num6, out items);
                for (int num23 = 0; num23 < NetItem.InventoryIndex.Item2; num23++)
                {
            ...
            if (items.Count > 0)
            {
                ...
                {
                    int num24 = Item.NewItem(new EntitySource_DebugCommand(), one.TPlayer.Center, new Vector2(5f, 5f), item.type, item.stack, true, 0, true, false);
        ...
        public static string cointostring(long coin, out List<Item> items)
        {
            ...
            coin /= 100;
            long num4 = coin;
            Item itemById = TShock.Utils.GetItemById(74);
            itemById.stack = (int)num4;
            items.Add(itemById);
            Item itemById2 = TShock.Utils.GetItemById(73);
            itemById2.stack = (int)num3;
            items.Add(itemById2);
            Item itemById3 = TShock.Utils.GetItemById(72);
            itemById3.stack = (int)num2;
            items.Add(itemById3);
            Item itemById4 = TShock.Utils.GetItemById(71);
