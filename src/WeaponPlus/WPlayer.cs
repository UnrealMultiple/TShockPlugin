...
public class WPlayer
{
    ...
    public bool isActive => this.me != null
        && this.me.Active
        && this.index == this.me.Index
        && this.me.TPlayer != null
        && this.index == this.me.TPlayer.whoAmI
        && this.me.TPlayer.active
        && this.name == this.me.Name
        && this.name == this.me.TPlayer.name;
