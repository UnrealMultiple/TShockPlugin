...
public class TShockConfigMultiLang : LazyPlugin
{
    ...
    private void configToNewconfig(CommandArgs args)
    {
        this.CTC();
        this.OnReload(args.Player);
    }
    ...
    protected override void Dispose(bool disposing)
    {
        if (disposing)
        {
            TShockAPI.Commands.ChatCommands.RemoveAll(x => x.CommandDelegate == this.configToNewconfig || x.CommandDelegate == this.configFromnNewconfig);
        }
