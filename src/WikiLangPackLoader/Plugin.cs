...
public class WikiLangPackLoader : TerrariaPlugin
{
    ...
    public override Version Version => new Version(2024, 9, 16, 0);
    ...
    public override void Initialize()
    {
        ...
        On.Terraria.Localization.LanguageManager.SetLanguage_GameCulture += this.LanguageManager_SetLanguage_GameCulture;
    ...
    private void Load()
    {
        ...
        var list = new List<IContentSource>
        {
