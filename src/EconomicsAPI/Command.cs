...
public class Command
{
    ...
    public void Bank(CommandArgs args)
    {
        ...
        if (args.Parameters.Count == 3)
        {
            ...
            switch (args.Parameters[0].ToLower())
            {
                ...
                case "del":
                {
                    ...
                    {
                        args.Player.SendSuccessMessage(GetString($"成功删除`{name}`的 {num} 个{Economics.Setting.CurrencyName}"));
                        return;
                    }
                ...
                case "pay":
                {
                    ...
                    {
                        args.Player.SendErrorMessage(GetString("你无权执行此命令!"));
                        return;
                    }
        ...
        else if (args.Parameters.Count == 1 && args.Parameters[0] == "help")
        {
            ...
            args.Player.SendInfoMessage(GetString("/bank del [用户] [数量]"));
