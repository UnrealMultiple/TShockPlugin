...
public class Commands
{
    public static void GnCmd(CommandArgs args)
    {
        ...
        {
            var isEnabled = Goodnight.Config.Enabled;
            Goodnight.Config.Enabled = !isEnabled;
            var statusStr = isEnabled ? "禁用" : "启用";
        ...
        {
            var enabled = Goodnight.Config.DiscPlayers;
        ...
        {
            var enabled = Goodnight.Config.Region;
        ...
        {
            var enabled = Goodnight.Config.PlayersInRegion;
