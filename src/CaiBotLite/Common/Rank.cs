...
public class Rank(string title, Dictionary<string, string> rankLines)
{
    ...
    [JsonIgnore]
    internal static readonly Dictionary<string, RankTypes> RankTypeMappings = new (StringComparer.OrdinalIgnoreCase) { ["boss"] = RankTypes.Boss, ["死亡"] = RankTypes.Death, ["在线"] = RankTypes.Online, ["钓鱼"] = RankTypes.Fishing };

    [JsonIgnore] public static List<string> SupportRankTypes => RankTypeMappings.Keys.ToList();
